...
#python ..\scripts\buildtools\build.py --deps ".\dependencies-plugins-min"

# to use the php build tool do:
#php -f ..\scripts\buildtools\build.php -- --deps=".\dependencies-min"
#php -f ..\scripts\buildtools\build.php -- --deps=".\dependencies-plugins-min"

# to use the node build tool do:
node ..\scripts\buildtools\build.js --deps ".\dependencies-min"
node ..\scripts\buildtools\build.js --deps ".\dependencies-plugins-min"
