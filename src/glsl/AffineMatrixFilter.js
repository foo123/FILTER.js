...
//
//
// AffineMatrix GLSL Filter  (IN PROGRESS!!)
FILTER.GLSL.AffineMatrixFilter = FILTER.Class( FILTER.GLSL.Filter, {
    
    name : "GLSL.AffineMatrixFilter",
