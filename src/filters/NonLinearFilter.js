...
(function(FILTER){
    ...
    FILTER.NonLinearFilter.prototype={
        ...
        median : function(d) { 
            ...
            this.dim=d; this._apply=this._MedianFilter; return this; 
        },
        
        erode : function(d) { 
            d=(typeof d == 'undefined') ? 3 : ((d%2) ? d : d+1);
            this.dim=d; this._apply=this._MinimumFilter; return this; 
        },
        
        dilate : function(d) { 
            d=(typeof d == 'undefined') ? 3 : ((d%2) ? d : d+1);
            this.dim=d; this._apply=this._MaximumFilter; return this; 
        },
        ...
        // used for internal purposes
        _dummyApply : function(src, sw, sh) {
            return src;
        },
        ...
        reset : function() {
            this._apply=this._dummyApply; this.dim=0; return this;
        }
    };
