(module
 ...
 (export "primitive_morphology_operator" (func $export:src/asm/morphologicalfilter/primitive_morphology_operator))
 (start $~start)
 ...
 (func $src/asm/morphologicalfilter/primitive_morphology_operator (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32) (param $6 i32) (param $7 i32) (param $8 i32) (param $9 i32) (result i32)
  (local $10 i32)
  (local $11 i32)
  (local $12 i32)
  (local $13 i32)
 ...
 (func $export:src/asm/morphologicalfilter/primitive_morphology_operator (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32) (param $6 i32) (param $7 i32) (param $8 i32) (param $9 i32) (param $10 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 16
  i32.sub
  global.set $~lib/memory/__stack_pointer
  ...
  local.get $9
  local.get $10
  call $src/asm/morphologicalfilter/primitive_morphology_operator
  local.set $0
  global.get $~lib/memory/__stack_pointer
  i32.const 16
  i32.add
