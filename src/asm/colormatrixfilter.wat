(module
 ...
 (data $11 (i32.const 1632) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00A\00\00\00\01\19")
 ...
 (export "colormatrixfilter" (func $export:src/asm/colormatrixfilter/colormatrixfilter))
 (start $~start)
 ...
 (func $src/asm/colormatrixfilter/colormatrixfilter (param $0 i32) (param $1 i32) (result i32)
  (local $2 f32)
  (local $3 i32)
  (local $4 f32)
  (local $5 i32)
 ...
 (func $export:src/asm/colormatrixfilter/colormatrixfilter (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  global.set $~lib/memory/__stack_pointer
  ...
  local.get $0
  local.get $3
  call $src/asm/colormatrixfilter/colormatrixfilter
  local.set $0
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.add
