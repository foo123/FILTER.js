...
* [Detection and Tracking of Point Features, Carlo Tomasi, Takeo Kanade 1991](https://citeseer.ist.psu.edu/viewdoc/download;jsessionid=370AA6BAEEE0D15F7BAC1883DDC0169F?doi=10.1.1.45.5770&rep=rep1&type=pdf)
...
* [Gray-level transformations for interactive image enhancement, Gonzales, Fittes 1977](https://www.semanticscholar.org/paper/Gray-level-transformations-for-interactive-image-Gonzales-Fittes/5a2aaf0062113a6937d2cecff6118c9355ed440f)
...
* [Multiple Histogram Matching, Shapira, Avidan, Hel-Or 2013](https://faculty.runi.ac.il/toky/publications/conference/hist_icip_13.pdf)
...
* [Fast and Provably Accurate Bilateral Filtering, Chaudhury, Dabhade 2016](https://arxiv.org/abs/1603.08109)
...
* [Use of the Hough Transformation to Detect Lines and Curves in Pictures, Duda, Hart 1972](https://comp-eng.binus.ac.id/files/2012/04/R.O.-Duda-Use-of-the-hough-transformation-to-detect-lines-and-curves-in-pictures.pdf)
* [The Adaptive Hough Transform, J. Illingworth, J. Kittler, 1987](https://www.semanticscholar.org/paper/The-Adaptive-Hough-Transform-Illingworth-Kittler/a474681a6e001fdec72482180e08da241504c626)
* [A new efficient ellipse detection method, Y. Xie and Q. Ji, 2002](https://sites.ecse.rpi.edu/~cvrl/Publication/pdf/Xie2002.pdf)
* [Generalizing the Hough Transform to Detect Arbitrary Shapes, Ballard 1981](https://www.cs.utexas.edu/~dana/HoughT.pdf)
...
* [A Shortest Augmenting Path Algorithm for Dense and Sparse Linear Assignment Problems, R. Jonker, A. Volgenant, 1986](https://gwern.net/doc/statistics/decision/1987-jonker.pdf)
...
* [Scale-invariant template matching using histogram of dominant gradients, Jisung Yoo, Sung Soo Hwang, Seong Dae Kim, Myung Seok Ki, Jihun Cha, 2014](https://daneshyari.com/article/preview/530403.pdf)
...
* [Efficient computational noise in GLSL, McEwan, Sheets, Gustavson, Richardson 2012](http://arxiv.org/abs/1204.1461)
...
* [A Graphics Hardware Implementation of the Generalized Hough Transform for fast Object Recognition, Scale, and 3D Pose Detection, Robert Strzodka, Ivo Ihrke, Marcus Magnor 2003](https://asc.ziti.uni-heidelberg.de/sites/default/files/research/papers/public/StIhMa03GHT.pdf)
...
* [Blind signal separation and identification of mixtures of images, Carmo, Teixeira de Assis, Estrela, Coelho 2009](https://arxiv.org/abs/1603.08095)
...
* [The watershed concept and its use in segmentation : a brief history, Meyer 2012](https://arxiv.org/abs/1202.0216)
...
* [SEEDS: Superpixels Extracted via Energy-Driven Sampling, Van den Bergh, Boix, Roig, Van Gool 2013](https://arxiv.org/abs/1309.3848v1)
