...
python ..\scripts\buildtools\build.py --deps ".\dependencies-basic"

REM to use the php build tool do:
REM php -f ..\scripts\buildtools\build.php -- --deps=".\dependencies-basic"

REM to use the node build tool do:
REM node ..\scripts\buildtools\build.js --deps ".\dependencies-basic"
